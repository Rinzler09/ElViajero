...
//Informacion del PDF
$pdf->SetCreator('grupo3');
$pdf->SetAuthor('grupo3');
...
$sqlTrabajadores = "SELECT * FROM clientes WHERE idcliente like '%$filtro%' OR nombre like '%$filtro%' OR DNI like '%$filtro%'";
//$sqlTrabajadores = ("SELECT * FROM trabajadores");
$query = mysqli_query($con, $sqlTrabajadores);

while ($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(20,6,$dataRow['idcliente'],1,0,'C');
        $pdf->Cell(50,6,($dataRow['nombre']),1,0,'C');
        $pdf->Cell(50,6,$dataRow['DNI'],1,0,'C');
        // $pdf->Cell(20,6,$dataRow['DNI'],1,0,'C');
...
$pdf->Output('ReporteClientes_'.date('d_m_y').'.pdf', 'I'); 

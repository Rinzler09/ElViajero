...
<?php
    ...
    {        
        ...
        $query = "INSERT INTO aerolineas (nombre, descripcion) 
        VALUES ('$nombre','$descripcion')";
        
        $con->probar($query);
        
        echo "<script>toastr.success('Aerolinea creado correctamente!','Aviso!');</script>";
    ...
    {       
        ...
        echo "<script>toastr.success('Aerolinea actualizado correctamente!','Aviso!');</script>";
...
<head>
    ...
    <script src="busquedaAerolinea.js"></script>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Administrar Aerolineas</h2>                      
                        <a href="#" class="btn btn-primary pull-right" data-toggle='modal' data-target='#newModal'>Agregar Aerolineas</a>
                    </div>
